...
We allow "\*.onrender.com" subdomains in `ALLOWED_HOSTS`, in addition to 127.0.0.1:
...
The corresponding `WSGI_APPLICATION` setting is configured to use the `application` variable from the `mysite.wsgi.application` module:
...
Make the Migration to the PostgreSQL DB
...
https:// your project at onrender.com/static/pso-django.jpg
